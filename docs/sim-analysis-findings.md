...
- **IDM logs in this analysis were generated after the `habitualRatRunProb` fix** (2026-04-03, commit 56a3348). Rat-run rates are correctly calibrated (L:1%, M:2%, H:3%). The IDM trip times reflect the corrected model.
