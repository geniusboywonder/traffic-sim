      ...
      <div className="findings-columns">
        ...
        <div className="findings-col findings-col--sideswipe">
          ...
          <ul className="findings-bullets">
            ...
            <li><strong>The congestion spreads back through the main roads.</strong> <strong>Dreyersdal Rd</strong> and <strong>Starke Rd</strong> are the primary collector roads feeding the study area — and under Medium and High demand, <strong>Dreyersdal Rd</strong> becomes the single most congested road in the entire network. The delays on <strong>Vineyard Rd</strong> (<span className="stat-pill" data-source="Validation model avg delay, Vineyard Rd, High scenario">86s</span>) and <strong>Ruskin Rd</strong> (<span className="stat-pill" data-source="Validation model avg delay, Ruskin Rd — Low: 106s, Med: 91s, High: 74s">74–106s</span>) confirm the same: the bottleneck at the gate backs up through the whole network.</li>
          </ul>
        </div>
