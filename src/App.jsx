      ...
      <div className="findings-columns">
        ...
        <div className="findings-col findings-col--fender">
          ...
          <ul className="findings-bullets">
            ...
            <li><strong>Christopher Rd is the physical funnel.</strong> Every inbound route — main and rat-run — must pass through two junctions on <strong>Christopher Rd</strong> before reaching the gate: a stop at <span className="stat-pill" data-source="J4: all-way stop, most congested junction on the approach — Lab model"><em>Starke/Christopher</em></span> and a yield at <span className="stat-pill" data-source="J5: yield-controlled, final junction before Vineyard/Leyden/school approach — all corridors pass through here"><em>Christopher/Vineyard</em></span>. There is no alternative path.</li>
          </ul>
        </div>
        ...
        <div className="findings-col findings-col--sideswipe">
          ...
          <ul className="findings-bullets">
            <li><strong>The rat-runs don't relieve pressure — they absorb it.</strong> <strong>Dreyersdal Rd</strong> becomes the most congested road in the network under Medium and High demand. <strong>Ruskin Rd</strong> averages <span className="stat-pill" data-source="Validation model avg delay, Ruskin Rd — Low: 106s, Med: 91s, High: 74s">74–106s of delay</span>. <strong>Vineyard Rd</strong> up to <span className="stat-pill" data-source="Validation model avg delay, Vineyard Rd, High scenario">86s</span>. When the main routes fill, the rat-runs fill too.</li>
            ...
            <li><strong>Three models, one answer.</strong> Live, Lab and the Validation model each use different mathematics — and each independently identifies <strong>Dreyersdal Rd</strong>, <strong>Starke Rd</strong> and the <em>Vineyard/Christopher</em> corridor as the most stressed roads in Medium and High demand. That's not a modelling quirk. It's the infrastructure.</li>
          </ul>
        </div>
