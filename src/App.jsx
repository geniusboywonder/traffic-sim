  ...
  <section className="findings-section" id="findings">
    <div className="findings-grid">
      ...
      <div className="findings-columns">
        ...
        <div className="findings-col findings-col--fender">
          ...
          <ul className="findings-bullets">
            ...
            <li><strong>Christopher Road is the final funnel.</strong> The main route and four separate rat-run paths — from all three entry corridors — converge on Christopher Road before the school gate. Two consecutive junctions compress all of that volume: a stop at Starke/Christopher and a yield at Christopher/Vineyard. The Validation model places Christopher Road in its <span className="stat-pill" data-source="Validation model peak inbound count — Low scenario rank 4 of all roads">top 5 most-loaded roads</span> even in the Low scenario. In Medium and High, it is absorbing <span className="stat-pill" data-source="Lab model — Dreyersdal #1, Starke #2/#3; all rat-run corridors pass through Christopher">overflow from every direction</span> simultaneously.</li>
          </ul>
        </div>
      ...
      <div className="road-closed-block" style={{ background: 'var(--surface-high)', border: '1.5px dashed #C47070', color: 'var(--on-surface)', marginTop: '3rem' }}>
        ...
        <p className="road-closed-intro" style={{ color: 'var(--muted-text)' }}>This modelling <strong>EXCLUDES</strong> any modelling for:</p>
        ...
        <p className="road-closed-footer" style={{ borderTopColor: 'rgba(0,0,0,0.1)', color: 'var(--muted-text)' }}>All Avg Time Out figures will be <strong>massively understated</strong> based on the above.</p>
      </div>
