...
import { PersonStanding, Database, Activity, FileText, Search, Info, AlertTriangle, Clock, CheckCircle, Split, Car, Play, Monitor, Timer, Map, Bot, OctagonX, ChevronUp, ChevronDown, Share2, Mail, X, HelpCircle } from 'lucide-react';
...
const ShareButtons = ({ onHelpClick }) => {
  ...
  return (
    <div className="share-buttons" style={{ position: 'relative' }}>
      <button className="share-btn share-btn--help" onClick={onHelpClick} title="Replay tour">
        <HelpCircle size={20} strokeWidth={2.5} />
      </button>

      {/* Mobile: single share icon that expands a popout */}
      <button
        className="share-btn share-btn--share mobile-share-trigger"
...
export default function App() {
  ...
  useEffect(() => {
    // Only control vertical scroll, never touch horizontal
    document.body.style.overflowY = initialized ? 'auto' : 'hidden';
    // Ensure horizontal overflow stays clipped (don't override CSS)
  ...
  return (
    <div className="app">
      ...
      <ProductTour active={initialized} restartKey={tourKey} />
