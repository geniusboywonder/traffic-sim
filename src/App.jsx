      ...
      <div className="findings-columns">
        ...
        <div className="findings-col findings-col--sideswipe">
          ...
          <ul className="findings-bullets">
            ...
            <li><strong>The rat-run shortcuts fill up too.</strong> <strong>Dreyersdal Rd</strong> and <strong>Starke Rd</strong> — residential streets, not designed for through-traffic — carry overflow from all three entry corridors. <strong>Dreyersdal Rd</strong> becomes the most congested road in the entire network under Medium and High demand. The delays on <strong>Vineyard Rd</strong> (<span className="stat-pill" data-source="Validation model avg delay, Vineyard Rd, High scenario">86s</span>) and <strong>Ruskin Rd</strong> (<span className="stat-pill" data-source="Validation model avg delay, Ruskin Rd — Low: 106s, Med: 91s, High: 74s">74–106s</span>) are on the final approach shared by both main routes and rat-runs — everyone converges on the same last 400m.</li>
          </ul>
        </div>
