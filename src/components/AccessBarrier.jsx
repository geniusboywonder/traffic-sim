      ...
      <div className="barrier-content-wrapper">
        ...
        <div className="barrier-main-grid">
          <div className="barrier-narrative">
            ...
            <p className="barrier-lekker">Just be lekker! <span className="barrier-lekker-sub">(no cars or humans were harmed in the making of this)</span><br /><span className="barrier-sig">ɲeill</span></p>
          </div>
